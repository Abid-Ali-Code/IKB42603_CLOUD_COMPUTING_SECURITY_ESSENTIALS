...
![LocalStack Environment Setup](images/lab1_setup.png)
...
![STS Caller Identity](images/lab1_task1_identity.png)
...
![LocalStack Endpoint Variable](images/lab1_task2.0_ep_var.png)
...
![Admins Group Creation](images/lab1_task2.1_group.png)
...
![Cloud Admin User Creation](images/lab1_task2.2_create_user.png)
...
![Cloud Admin Added to Group](images/lab1_task2.3_add_to_group.png)
...
![Admins Group Verification](images/lab1_task2.4_get_group.png)
...
![Analyst User Creation](images/lab1_task3.1_create_analyst.png)
...
![Analyst Read-Only Policy Attachment](images/lab1_task3.2_attach_policy.png)
...
![Analyst Policy Verification](images/lab1_task3.3_list_policies.png)
...
![Analyst Access Key Creation](images/lab1_task4.1_create_key.png)
...
![Analyst Access Key Listing](images/lab1_task4.2_list_keys.png)
...
![Access Key Deactivation](images/lab1_task4.3_deactivate_key.png)
...
![Kubernetes Cluster Setup](images/lab1_setup_cluster.png)
...
![Kubernetes Namespaces](images/lab1_task5-6_namespaces_role.png)
...
![Service Account Role and RoleBinding](images/lab1_task6_rolebinding.png)
...
![RBAC Allowed Test](images/lab1_task7_can_i_results.png)
...
![RBAC Denied Tests](images/lab1_verification_command.png)
...
> **Evidence Status:** The image file named `lab1_verification_command.png` in the supplied evidence does **not** contain the YAML output of the verification command. It contains the two denied `kubectl auth can-i` tests instead. Because the actual YAML output was not included in the provided evidence, it is not fabricated in this report.
...
└── images/
    ├── lab1_setup.png
    ├── lab1_setup_cluster.png
    ├── lab1_task1_identity.png
    ├── lab1_task2.0_ep_var.png
    ├── lab1_task2.1_group.png
    ├── lab1_task2.2_create_user.png
    ├── lab1_task2.3_add_to_group.png
    ├── lab1_task2.4_get_group.png
    ├── lab1_task3.1_create_analyst.png
    ├── lab1_task3.2_attach_policy.png
    ├── lab1_task3.3_list_policies.png
    ├── lab1_task4.1_create_key.png
    ├── lab1_task4.2_list_keys.png
    ├── lab1_task4.3_deactivate_key.png
    ├── lab1_task5-6_namespaces_role.png
    ├── lab1_task6_rolebinding.png
    ├── lab1_task7_can_i_results.png
    └── lab1_verification_command.png
```
